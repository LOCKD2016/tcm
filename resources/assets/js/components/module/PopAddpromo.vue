<!--物流状态-->
<template>
    <div id="addpromo" class="modal fade">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="length" type="text" value="6位" v-model="length" readonly="readonly"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="total" type="text" placeholder="请输入优惠码数量" v-model="total"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input name="discount" type="text" placeholder="请输入优惠金额" v-model="discount"
                                       class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <input type="text" readonly="readonly" name="goods_start"
                                       @click.stop="open($event,'picker2')" v-model="calendar.items.picker2.value"
                                       placeholder="请输入邀请开始时间" class="form-control time_date"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <input type="text" readonly="readonly" name="goods_end"
                                       @click.stop="open($event,'picker3')" v-model="calendar.items.picker3.value"
                                       placeholder="请输入邀请截止时间" class="form-control time_date"/>
                                <calendar :show.sync="calendar.show" :type="calendar.type" :value.sync="calendar.value"
                                          :x="calendar.x" :y="calendar.y" :begin.sync="calendar.begin"
                                          :end.sync="calendar.end" :range.sync="calendar.range"
                                          :months="calendar.months"></calendar>
                            </div>
                        </div>
                        <div class="form-group btn_box">
                            <button type="button" @click="goback()" class="btn btn-lg btn-default">取消
                                <button id="subUpload" type="button" @click="saveGood()" class="btn btn-lg btn-primary">
                                    添加
                                </button>
                            </button>
                        </div>
